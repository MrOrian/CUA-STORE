...
public class Clothes {
    ...
    public Clothes(long id,String clothesName, String clothesType, Long clothesPrice, String clothesBrand, String clothesImage, String clothesDescription, String clothesStatus) {
        this.id = id;
    ...
    public Clothes(String clothesName, String clothesType, Long clothesPrice, String clothesBrand, String clothesImage, String clothesDescription, String clothesStatus) {
        this.clothesName = clothesName;
        this.clothesType = clothesType;
        this.clothesPrice = clothesPrice;
        this.clothesBrand = clothesBrand;
